 ...
 */
public class ExecutionServiceException extends TestEngineException {
	...
	public ExecutionServiceException(Exception cause) {
		super(cause);
	}

	public ExecutionServiceException(String message, Exception cause) {
		super(message, cause);
	}

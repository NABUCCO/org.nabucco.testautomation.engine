 ...
 */
public class TestScriptException extends NBCTestException {
     ...
     */
    public TestScriptException(String message, Exception cause) {
        super(message, cause);
    }
     ...
     * @param cause the root cause
     */
    public TestScriptException(Exception cause) {
        super(cause);
    }

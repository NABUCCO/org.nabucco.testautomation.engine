...
public class TestEngineImpl extends UnicastRemoteObject implements TestEngine {
	...
	private static final NBCTestLogger logger = NBCTestLoggingFactory
			.getInstance().getLogger(TestEngineImpl.class);
	 ...
	 */
	@Override
	public TestExecutionInfo executeTestConfiguration(TestConfiguration testConfiguration,
			TestContext context) throws TestEngineException {
		...
		try {
			...
			logger.info("[JobId:" + jobId + "] Started execution of TestConfiguration: " + testConfiguration.getName().getValue());
	 ...
	 */
	@Override
	public TestConfigurationResult getTestConfigurationResult(TestExecutionInfo testInfo)
	 ...
	 */
	@Override
	public TestExecutionInfo getTestStatus(TestExecutionInfo testInfo)
			throws TestEngineException {
	 ...
	 */
	@Override
	public TestExecutionInfo cancelTestConfiguration(TestExecutionInfo testInfo)
	 ...
	 */
	@Override
	public void setClientInteraction(TestExecutionInfo testInfo,
			ClientInteraction userInput) throws TestEngineException, RemoteException {
		long jobId = testInfo.getJobId().getValue();

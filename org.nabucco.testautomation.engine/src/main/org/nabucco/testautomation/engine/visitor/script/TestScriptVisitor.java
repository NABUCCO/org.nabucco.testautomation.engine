...
public class TestScriptVisitor extends AbstractTestScriptVisitor<TestScriptResult> {
    ...
    private static final NabuccoLogger logger = NabuccoLoggingFactory.getInstance().getLogger(TestScriptVisitor.class);
    ...
    public void visit(TestScript script, TestScriptResult argument) throws TestScriptException {
        logger.info("Visiting TestScript '", script.getIdentificationKey(), "'");
        super.visit(script, argument);
        logger.info("Finished visiting TestScript '", script.getIdentificationKey(), "'");
    }
